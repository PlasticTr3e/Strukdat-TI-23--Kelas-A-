...
//Struct mahasiswa berisi nama, npm, dan nilai
struct Mahasiswa
{
    string npm, nama;
    int nilai;
...
void cetakMahasiswa(dataMhs mhs, int n){
    ...
    cout << "----------------------------------------------------------------------------" << endl;
    cout << "No\tNMP\tNama\tNilai\t" << endl;
    cout << "----------------------------------------------------------------------------" << endl;
    for (int i = 0; i < n; i++) {
        cout << i + 1 << "\t" << mhs[i].npm << "\t" << mhs[i].nama << "\t" << mhs[i].nilai;
        cout << endl;
    }
    cout << "----------------------------------------------------------------------------" << endl;
}
...
void cariData(string npm, dataMhs data, int n){
    for (int  i = 0; i < n; i++)
    {
        if (npm == data[i].npm)
        {
            cout << "Ditemukan NPM = " << npm << ", Nama = " << data[i].nama << ", Nilai = " << data[i].nilai << endl;
        }
    }
